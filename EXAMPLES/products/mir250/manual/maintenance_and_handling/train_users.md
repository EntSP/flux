...
{% partial file="partials/user_types/text_indirect_user.md" /%}

### Direct users

{% partial file="partials/user_types/text_direct_user.md" /%}

### Operators

{% partial file="partials/user_types/text_operators.md" /%}

### Commissioners

{% partial file="partials/user_types/text_commissioner.md" /%}
...
{% notice type="info" %}
MiR Academy offers training material that covers most of the topics required for operators and direct users. You can also apply for Classroom Training, which provides hands-on practice that builds on Academy material. For more information, see [MiR Academy](https://academy.mobile-industrial-robots.com/)
{% /notice %}

### Visitor and indirect user training

{% partial file="partials/training/text_indirect_users_visitor_training.md" /%}

### Direct user training

{% partial file="partials/training/table_direct_user_training.md" /%}

### Training of operators

{% partial file="partials/training/table_operator_training.md" /%}